        ...
        <div className="container-fluid footer" style={{ backgroundColor: "#101725" }}>
            <MDBFooter color="black" className="font-small pt-4 mt-4">
                <MDBContainer fluid className="text-center text-md-left">
                    <MDBRow>
                        <MDBCol md="6">
                            <h5 className="title" style={{ color: "white" }}>Events Management Site</h5>
                            <p>
                               EventsGo <br />
                                RGUKT Basar
                            </p>
                ...
                <div className="footer-copyright text-center py-3">
                    <MDBContainer fluid>
                        &copy; {new Date().getFullYear()}<a href="#" style={{ textDecoration: 'none', color: '#fefefe' }}> EventsGO RGUKT Basar</a>
                    </MDBContainer>
                </div>
            </MDBFooter>
        </div>
